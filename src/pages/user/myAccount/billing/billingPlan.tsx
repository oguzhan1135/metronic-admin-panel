                    ...
                    <table className=" border-collapse  min-w-[700px]">
                        <thead>
                            <tr className="bg-gray-100">
                                <th className="px-[30px] py-[13px] ">
                                    <span className="text-b-13-14-400 text-gray-700"></span>
                                </th>
                                <th className="px-[30px] py-[13px] text-left border">
                                    <div className="flex flex-col  gap-5">
                                        <div className="flex flex-col gap-2.5">
                                            <span className="text-b-18-18-500 text-gray-900">Basic</span>
                                            <p className="text-b-13-20-400 text-gray-700">Essential features for startups & individuals</p>
                                        </div>
                                ...
                                <th className="px-[30px] py-[13px] text-left border">
                                    <div className="flex flex-col  gap-5">
                                        <div className="flex flex-col gap-2.5">
                                            ...
                                            <p className="text-b-13-20-400 text-gray-700">Advanced tools for growing businesses</p>
                                        </div>
                                        <div className="flex flex-row items-end gap-[6px]">
                                ...
                                <th className="px-[30px] py-[13px] text-left border">
                                    <div className="flex flex-col  gap-5">
                                        <div className="flex flex-col gap-2.5">
                                            ...
                                            <p className="text-b-13-20-400 text-gray-700">Comprehensive suite for large-scale operations</p>
                                        </div>
                                        <div className="flex flex-row items-end gap-[6px]">
                                ...
                                <th className="px-[30px] py-[13px] text-left border">
                                    <div className="flex flex-col  gap-5">
                                        <div className="flex flex-col gap-2.5">
                                            ...
                                            <p className="text-b-13-20-400 text-gray-700">Tailored solutions for enterprise needs</p>
                                        </div>
                                        <div className="flex flex-row items-end gap-[6px]">
                    ...
                    <>
                        <div className="flex flex-col py-2.5 px-[30px]">
                            {questions.map((item, index) => (
                                <div
                                    key={index}
                                    className={`flex flex-col ${item.status ? "gap-5" : "gap-0"} py-5 border last:border-0 cursor-pointer`}
