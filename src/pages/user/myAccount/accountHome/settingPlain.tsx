                    ...
                    content={
                        ...
                        <div className="flex flex-col px-[30px] pt-5">
                            ...
                            <div className="flex flex-col items-start md:flex-row md:items-center gap-4 md:gap-0 py-2.5">
                                ...
                                <div className="bg-light-active border-gray-300  rounded-md p-3 border w-full md:min-w-[330px]">
                            ...
                            <div className="flex flex-col items-start md:flex-row md:items-center gap-4 md:gap-0 py-2.5">
                                ...
                                <select name="" id="" defaultValue={"Spain"} className="bg-light-active border-gray-300  rounded-md p-3 border w-full outline-none text-gray-800 ">
                            ...
                            <div className="flex flex-col items-start md:flex-row md:items-center gap-4 md:gap-0 py-2.5">
                                ...
                                <select name="" id="" defaultValue={"Barcelona"} className="bg-light-active border-gray-300  rounded-md p-3 border w-full outline-none text-gray-800">
