...
import AccountDeavtivated from '../../../assets/icon/account-deactivated- modal.svg'
...
const AccountDeactivatedModal = () => {
    ...
    return (
        <div className="flex flex-col gap-10">
            ...
            <ModalContent>
                <div className="flex flex-col gap-[30px] items-center p-10">
                    <img src={AccountDeavtivated} alt="welcome" />
                    <div className="flex flex-col gap-[14px] items-center">

                        <h3 className='text-h-26-26-600 text-gray-900'>Account Deactivated</h3>
                        <p className='text-b-13-20-400 text-gray-700 text-center'> Your account has been deactivated. Please contact
                            support if this is an error or for reactivation.</p>
                    </div>
                    <Link to={"/"} className="flex items-center justify-center rounded-md bg-primary text-white text-b-13-14-500 px-4 py-[13px] w-max">Go to Home</Link>
                </div>
            </ModalContent>
        </div>
    );
