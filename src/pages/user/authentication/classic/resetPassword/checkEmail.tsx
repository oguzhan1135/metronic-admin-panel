                    ...
                    <>
                        <form action="#" className="flex flex-col gap-[30px] p-10 items-center">
                            ...
                            <div className="flex flex-col gap-5 items-center w-full">
                                <a href="/user/authentication/classic/resetPassword/resetPassword" className="bg-primary flex items-center justify-center w-full text-white text-b-13-14-500 rounded-md py-[13px]">
                                    Skip for now
                                </a>
