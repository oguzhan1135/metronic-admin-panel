                    ...
                    <>
                        <form action="#" className="flex flex-col gap-[30px] p-10 items-center dark:bg-coal-500">
                            ...
                            <div className="flex flex-col gap-5 items-center w-full">
                                <a href="/user/authentication/branded/resetPassword/checkEmail" className="bg-primary flex items-center flex-row gap-[6px] justify-center w-full text-white text-b-13-14-500 rounded-md py-[13px]">
                                    Contoinue
