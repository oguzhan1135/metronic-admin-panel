...
const ModalContent: React.FC<ModalProps> = ({ children }) => {
    ...
    return (
        ...
        >
            <div
                className="relative bg-white rounded-lg shadow-lg w-[90%] max-w-[1200px] max-h-[800px] overflow-hidden"
        ...
        <div className="flex flex-col gap-10">
            ...
            <ModalContent>
                <div className="flex flex-col gap-10 ">
                    ...
                    {/* Sub menu */}
                    <Menu />
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-[30px] p-4 max-h-[600px] overflow-y-scroll">
