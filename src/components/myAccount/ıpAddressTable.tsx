                            ...
                            <table className=" border-collapse  min-w-[700px]">
                                <thead>
                                    <tr className="bg-gray-100">
                                        <th className="px-[21px] py-[11px] text-center border">
                                            <input type="checkbox" className="size-[18px]" name="all" id="all" />
                                        </th>
                                        <th className="px-5 py-[13px] border ">
                                ...
                                <tbody>
                                    {
                                        upgradeData.map((item) => (
                                            <tr className="border-t" key={item.id}>
                                                <td className='px-[21px]  py-[26px] text-center '>
                                                ...
                                                <td className='px-5 py-[26px]  text-left'>
