...
const ModalContent: React.FC<ModalProps> = ({ children }) => {
    const { shareModal, setShareModal } = metronicContext()
...
const Share = () => {
    const { setShareModal } = metronicContext()
                ...
                <div className="flex flex-col  bg-white dark:bg-coal-500 max-w-[550px] max-h-[650px] rounded-xl">
                    <div className="flex flex-col">
                        <div className="border-b p-5">
                            <h3 className='text-b-14-14-600 text-gray-900'>Share Profile</h3>
                        </div>
                        <div className="border-b p-5">
                        ...
                        <div className="border-b p-5">
                            <div className="flex flex-col gap-2.5">
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <button onClick={() => setShareModal(false)} className='text-white text-b-13-14-500 py-[13px] rounded-md bg-primary flex items-center justify-center'>Done</button>
                                </div>
                            </div>
                        </div>
                    </div>
