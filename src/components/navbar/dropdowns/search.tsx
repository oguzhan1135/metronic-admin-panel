...
const Search = () => {
    ...
    const [items, setItems] = useState<SearchItems[]>([
        {
            ...
            subItems: "shortcuts",
            content:
                <Link to={"#"} className="flex flex-row items-center p-2.5 gap-2.5 cursor-pointer hover:bg-gray-100 rounded-md hover: group">
        ...
        },
        {
            ...
            subItems: "shortcuts",
            content:
                <Link to={"#"} className="flex flex-row items-center p-2.5 gap-2.5 cursor-pointer hover:bg-gray-100 hover: group rounded-md ">
    ...
    const [filtredItem, setFiltredItem] = useState<SearchItems[]>([]);
    ...
    useEffect(() => {
        ...
        if (filtered.length === 0) {
            setSelectedTab("No Results")
        }

        setFiltredItem(filtered);
    }, [searchTerm, items]);
            ...
            <ModalContent>
                <div className="flex flex-col  bg-white dark:bg-coal-500 max-w-[550px] max-h-[500px] rounded-xl">
                    <div className="flex flex-row items-center gap-2 min-w-[300p] p-5">
                        ...
                        <input type="text" className="outline-none bg-transparent text-13-14-400 text-gray-800 w-full" placeholder="Tap to start search.." value={searchTerm}
                    ...
                    <div className="flex flex-col overflow-y-auto custom-scroll max-h-[500px]">
                        ...
                        {
                            filtredItem.length > 0 && searchTerm !== "" ?
                                ...
                                <>
                                    {selectedTab === "Mixed" && (
                                        <div className="flex flex-col">
                                            <div className="p-5 flex flex-col gap-[6px] border-b">
                                    ...
                                    {selectedTab === "Settings" && (
                                        <div className="flex flex-col gap-2.5">
                                            <div className="px-5 pt-5 flex flex-col gap-[6px]">
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    {
                                                        items.filter((prev) => prev.subItems === "shortcuts").map((item) => (
                                                            item.content
                                                        ))
                                                    }
                                                </div>
                                            ...
                                            <div className="px-5 flex flex-col gap-[6px] border-b">
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    {
                                                        items.filter((prev) => prev.subItems === "action").map((item) => (
                                                            item.content
                                                        ))
                                                    }
                                                </div>
                                    ...
                                    {selectedTab === "Integrations" && (
                                        <div className="px-2.5 pt-2.5 flex flex-col gap-[6px] border-b">
                                            <div className="flex flex-col gap-1">
                                                {
                                                    items.filter((prev) => prev.category === "integrations").map((item) => (
                                                        item.content
                                                    ))
                                                }
                                            </div>
                                    ...
                                    {selectedTab === "Users" && (
                                        <div className="px-2.5 pt-2.5 flex flex-col border-b">
                                            <div className="flex flex-col gap-1">
                                                {
                                                    items.filter((prev) => prev.category === "user").map((item) => (
                                                        item.content
                                                    ))
                                                }
                                            </div>
                                    ...
                                    {selectedTab === "Docs" && (
                                        <div className="px-2.5 pt-2.5 flex flex-col border-b">
                                            <div className="flex flex-col gap-1">
                                                {
                                                    items.filter((prev) => prev.category === "docs").map((item) => (
                                                        item.content
                                                    ))
                                                }
                                            </div>
