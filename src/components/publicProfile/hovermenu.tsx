        ...
        <div className="flex lg:flex-row flex-col items-center justify-between border-b relative">
            <div className="w-full overflow-x-auto flex xl:justify-between items-center custom-scroll">
                <div className="flex flex-row items-center gap-2.5 min-w-[250px]">
                    ...
                    >
                        <a className={`text-b-14-14-500 ${location.startsWith("/user/publicProfiles/campaigns") || location.startsWith("/user/publicProfiles/empty") ? "text-primary" : "text-gray-700"} `}>More</a>
                        <FaChevronDown className={`text-b-14-14-500 ${location.startsWith("/user/publicProfiles/campaigns") || location.startsWith("/user/publicProfiles/empty") ? "text-primary" : "text-gray-700"} `} />
