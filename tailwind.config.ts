...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'map': "url('/src/assets/background-map.svg')",
        'map-dark': "url('/src/assets/map-dark.svg')",
        'mask': "url('/src/assets/mask.svg')",
        'author-bg-1': "url('/src/assets/author-bg-1.svg')",
        'author-bg-2': "url('/src/assets/author-bg-2.svg')",
        'author-bg-3': "url('/src/assets/author-bg-3.svg')",
        'author-bg-4': "url('/src/assets/author-bg-4.svg')",
        'layered-bg': "url('/src/assets/layared-bg.svg')",
        'authantication-bg': "url('/src/assets/authentication-bg.svg')",
        'branded-bg': "url('/src/assets/branded-bg.svg')",
        'author-dark': "url('/src/assets/author-dark.svg')",
        'nft-dark': "url('/src/assets/nft-dark.svg')",
        'authentication-dark': "url('/src/assets/authentication-dark.svg')",
        'branded-dark': "url('/src/assets/branded-dark.svg')",
